...
export const ImagingVideos = () => {
  return (
    <VideoSection id="imaging" title="Imaging/Radiology" color="blue-400">
      <VideoItem 
        title="Imaging and Radiology in Sarcoma"
        description="Resources related to imaging and radiology for sarcoma patients"
      />
    </VideoSection>
  );
};
