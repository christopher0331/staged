...
export const NutritionVideos = () => {
  return (
    <VideoSection id="nutrition" title="Nutrition" color="green">
      <VideoItem 
        title="Guidance on Diet during Chemo / During Clinical Trials and more"
        presenter="Alison Tierney, MS, RD, CD, CSO, Licensed Cancer Dietician and Cancer Survivor"
        date="May 22, 2024"
        description="Ms. Tierney empowers those affected by cancer to conquer fears, take back control, and fully support their body before, during, and after cancer treatment."
        link="https://www.youtube.com/watch?v=6z21Z6ls33c"
      />
    </VideoSection>
  );
};
