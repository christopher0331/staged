...
export const GeneralInfoVideos = () => {
  return (
    <VideoSection id="general" title="General Information on Sarcoma Care - Multidisciplinary Approach" color="indigo">
      <VideoItem 
        title="Vanderbilt Sarcoma Center Education Video"
        presenter="Dr. Elizabeth Davis, Vanderbilt University"
        date="July 14, 2022"
        description="Patient learning hour about sarcoma and its multidisciplinary treatment at Vanderbilt University"
        link="https://youtu.be/2FuOuLewaJl"
      />
      
      <VideoItem 
        title="Brief Background on LMS and Treatment Options"
        presenter="Dr. Elizabeth Davis, Vanderbilt Cancer Center"
        date="August 20, 2020"
        description="Covers systemic treatment, importance of supportive care, and clinical trials on the horizon"
        link="https://youtu.be/U-JW4GYi3tA"
      />
      
      <VideoItem 
        title="UCLA-NLMSF Patient/Family LMS Education Symposium"
        date="February 2017"
        description="Comprehensive symposium covering drug development, personalized therapy, surgical management, radiation therapy, immunotherapy trials, nutrition, and patient discussion"
        link="https://www.uclahealth.org/sarcoma/leiomyosarcoma-education-day"
      />
    </VideoSection>
  );
};
