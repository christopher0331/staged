...
export const CaregivingVideos = () => {
  return (
    <VideoSection id="caregiving" title="Caregiving" color="amber">
      <VideoItem 
        title="Caregiving Counts"
        presenter="Dr. Marya Shegog, Lararex Foundation"
        date="August 20, 2022"
        description="Hosted by the NLMSF"
        link="https://youtu.be/EhYR2LHtSdU"
      />
    </VideoSection>
  );
};
