...
export const PathologyVideos = () => {
  return (
    <VideoSection id="pathology" title="Pathology" color="orange">
      <VideoItem 
        title="Perspectives on Pathology and Recent Research"
        presenter="Dr. Josephine Dermawan, Cleveland Clinic"
        date="May 2024"
        description="Discusses her perspectives on pathology and her recent research publication"
        link="https://youtu.be/Ks30Ztm7QWQ"
      />
      
      <VideoItem 
        title="Basic Lecture on Pathology of Sarcoma"
        presenter="Dr. Alexander Lazar, MD Anderson Cancer Center"
        date="August 3, 2020"
        description="Hosted by the NLMSF"
        link="https://www.youtube.com/watch?v=gjvcYEdOZmw"
      />
    </VideoSection>
  );
};
