...
export const MicrobiomeVideos = () => {
  return (
    <VideoSection id="microbiome" title="The Microbiome (Gut Health) and its Impact on Treatments" color="teal">
      <VideoItem 
        title="The Microbiome (Gut Health) and its Impact on the Effectiveness of Chemotherapy Treatment"
        presenter="Dr. Elise Nassif, MD Anderson Cancer Center"
        date="February 17, 2023"
        description="Hosted by the NLMSF"
        link="https://youtu.be/NtEdB4bno5E"
      />
    </VideoSection>
  );
};
