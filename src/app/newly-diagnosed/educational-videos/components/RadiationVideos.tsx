...
export const RadiationVideos = () => {
  return (
    <VideoSection id="radiation" title="Radiation Therapy" color="yellow">
      <VideoItem 
        title="Should Hypofractionated Radiation be Adopted as the Standard of Care for Extremity and Truncal Sarcomas"
        presenter="Dr. B. Ashleigh Guadagnolo, MD Anderson Cancer Center"
        date="February 2025"
        description="Hosted by the NLMSF"
        link="https://youtu.be/CV17JtEHWqM"
      />
      
      <VideoItem 
        title="The Role of Radiation Oncology in LMS"
        presenter="Dr. Anush Kalbasi, UCLA Department of Oncology and UCLA Comprehensive Cancer Center"
        date="May 15, 2021"
        description="Hosted by the NLMSF"
        link="https://youtu.be/NuNNaaOV_9Q"
      />
    </VideoSection>
  );
};
