...
export const ResearchVideos = () => {
  return (
    <VideoSection id="research" title="Basic Research" color="purple">
      <VideoItem 
        title="The Importance of Telemeres in Leiomyosarcoma"
        presenter="Dr. Priya Chudasama of Heibelberg University, Germany"
        date="July 19, 2022"
        description="Hosted by the NLMSF"
        link="https://www.youtube.com/watch?v=s5xJqpD0oMA"
      />
      
      <VideoItem 
        title="LMS Connect Live"
        presenter="Program Moderator: Jonathan Trent, MD, PhD - Sylvester Comprehensive Cancer Center, Miami University"
        date="March 18, 2022"
        description="Speakers: Matthew Hemming, MD, PhD (Harvard/Dana-Farber) discusses laboratory models of leiomyosarcoma, and Nicolas Llosa, MD (Johns Hopkins) discusses the immune microenvironment of LMS."
        link="https://youtu.be/lgXPwxdB8pM"
      />
    </VideoSection>
  );
};
