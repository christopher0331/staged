...
export const DiagnosisVideos = () => {
  return (
    <VideoSection id="diagnosis" title="ABC's of a New Diagnosis" color="blue">
      <VideoItem 
        title="The ABC's of a New Diagnosis"
        presenter="Presented by the NLMSF"
        date="May 22, 2023"
        link="https://youtu.be/9pnKTkzqOw0"
      />
      
      <VideoItem 
        title="Introduction to the ABC's of a New Diagnosis"
        presenter="Presented by the NLMSF"
        date="January 16, 2022"
        link="https://youtu.be/BJBK8bJOOaw"
      />
      
      <VideoItem 
        title="THE MAYO CLINIC and the NLMSF present: The ABC's of a Sarcoma Diagnosis"
        link="https://www.youtube.com/watch?v=nv2HP9TbaYA"
      />
    </VideoSection>
  );
};
