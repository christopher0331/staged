...
export const ImmunotherapyVideos = () => {
  return (
    <VideoSection id="immunotherapy" title="Immunotherapy" color="purple">
      <VideoItem 
        title="Discussion of the ASCO Publication – Immunotherapy in Sarcoma"
        presenter="Dr. Christian Meyer, The Johns Hopkins Cancer Institute Sarcoma Center"
        date="August 26, 2024"
        description="Current Data and Promising Strategies for Immunotherapy in Sarcoma"
        link="https://youtu.be/ogP5bVDSI3M"
      />
      
      <VideoItem 
        title="Targeting the Molecular and Immunological Features of LMS"
        presenter="Dr. Elise Nassif, MD Anderson Cancer Center"
        date="June 9, 2023"
        link="https://youtu.be/qaYjM2GPYzk"
      />
      
      <VideoItem 
        title="Current Status and Future Directions of Immunotherapies in Soft Tissue Sarcomas"
        presenter="Dr. Jonathan Trent, Sylvester Comprehensive Cancer Center"
        date="February 28, 2023"
        link="https://youtu.be/W9QnMxDOeQM"
      />
      
      <VideoItem 
        title="Immunotherapy for Sarcoma: A Work in Progress"
        presenter="Dr. Christian Meyer, The Johns Hopkins Sidney Kimmel Comprehensive Cancer Center"
        date="April 14, 2022"
        description="Dr. Meyer discusses his recent article published in the Journal of Clinical Oncology"
        link="https://youtu.be/w9o46xJ0cvA"
      />
    </VideoSection>
  );
};
